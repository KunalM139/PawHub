...
function getName(val: unknown): string {
  ...
  if (typeof val === "object" && val !== null && "name" in val) {
    return (val as { name?: string }).name ?? "User";
  }
  return "User";
}
      ...
      >
        {messages.length === 0 ? (
          <EmptyState
            ...
            description="Start a conversation by contacting a seller from a listing page."
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1.5 text-[10px] text-[var(--color-foreground-subtle)]">
                        {new Date(msg.createdAt as string).toLocaleDateString("en-IN", {
                          day: "numeric",
                          month: "short",
                          hour: "2-digit",
                          minute: "2-digit",
