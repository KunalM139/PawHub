...
export const metadata: Metadata = {
  title: "Contact Us | PawHub",
  description: "Get in touch with the PawHub team for support, inquiries, or feedback.",
};
        ...
        <div className="glass-panel p-8 md:p-16 rounded-[2.5rem] card-shadow">
          ...
          <div className="prose prose-lg max-w-none text-[var(--color-on-surface-variant)] leading-relaxed">
            <p className="text-xl font-medium mb-8">
              Have questions? We're here to help. Reach out to us at support@pawhub.in or call us at +91 1800-PAWHUB-123. Our team is available Monday through Friday, 9 AM to 6 PM IST.
            </p>
            <p>
              This is a placeholder page designed to complete the site's structure. In a full production environment, this page would contain a contact form or detailed support information.
            </p>
